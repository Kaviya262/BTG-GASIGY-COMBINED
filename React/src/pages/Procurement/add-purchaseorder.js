    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Breadcrumbs title="Procurement" breadcrumbItem="Add Purchase Order" />
                    <Row>
                        <Col lg="12">
                            <Card>
                                <CardBody>
                                            ...
                                            <Form>
                                                 <div className="row align-items-center g-3 justify-content-end">
                                                    <div className="col-md-12 button-items">
                                                        ...
                                                        <button type="button" className="btn btn-info fa-pull-right"><i className="bx bx-comment-check label-icon font-size-16 align-middle me-2"></i>Save</button>
                                                    </div>
                                                </div>
                                                ...
                                                <Row className="mb-3">
                                                    <Col md={4}>
                                                        <FormGroup>
                                                            <Label htmlFor="prNo" className="fw-bold">PR No.</Label>
                                                            <Field
                                                                as="select"
                                                                name="prNo"
                                                                ...
                                                                onChange={(e) => {
                                                                    ...
                                                                    setFieldValue("prNo", value);

                                                                    // Map PR No. to PR Type
                                                                    let prType = "";
                                                                    if (value === "GPR0001") prType = "General PR";
                                                                    else if (value === "BGPR0001") prType = "Bulk Gas PR";
                                                                    else if (value === "SOPR0001") prType = "Service Order PR";
                                                                    else if (value === "PBPR0001") prType = "Project Based PR";

                                                                    setFieldValue("prtype", prType);
                                                                }}
                                                            >
                                                                <option value="">Select PR No</option>
                                                                <option value="GPR0001">GPR0001</option>
                                                                <option value="BGPR0001">BGPR0001</option>
                                                                <option value="SOPR0001">SOPR0001</option>
                                                                <option value="PBPR0001">PBPR0001</option>
                                                            </Field>
                                                        </FormGroup>
                                                    </Col>
                                                    <Col md={4}>
                                                        <FormGroup>
                                                            <Label htmlFor="prtype" className="fw-bold">PR Type</Label>
                                                            <Field
                                                                name="prtype"
                                                                type="text"
                                                                disabled
