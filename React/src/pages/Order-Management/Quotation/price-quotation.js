    ...
    const handleSubmit = async (e, actionType) => {
        ...
        if (!hasError) {
            try {
                ...
                const response = await UpdateSQ({ header: updatedSQBasicInfo, details: quotationDetails, operation: OpContactList });
                if (response?.status) {
                                                                ...
                                                                <div className="col-xl-4">
                                                                    <Col md="12">
                                                                        <FormGroup>
                                                                            ...
                                                                            <Input type="select" disabled name="SQ_Type" id="SQ_Type" onChange={handleInputChange} className={errorClass.SQ_Type} value={sqbasicinfo.SQ_Type} >
                                                                    ...
                                                                    <Col md="12">
                                                                        <FormGroup>
                                                                            ...
                                                                            <Input type="text" disabled name="Sys_SQ_Nbr" id="Sys_SQ_Nbr" onChange={handleInputChange} className={errorClass.Sys_SQ_Nbr} value={sqbasicinfo.Sys_SQ_Nbr} maxLength={20} />
                                                                        </FormGroup>
                                                                    </Col>
                                                                    <Col md="12">
                                                                        <FormGroup>
                                                                            ...
                                                                            <InputGroup>
                                                                                ...
                                                                                <Input type="text" name="EffectiveFromDate" id="EffectiveFromDate" disabled
                                                                                    value={new Date(defaultSQDate).toLocaleDateString('en-GB', {
                                                                                        day: '2-digit',
                                                                                        month: 'short',
                                                                                        year: 'numeric'
                                                                                    }).replace(/ /g, '-')} />
                                                                    ...
                                                                    <Col md="12">
                                                                        <FormGroup>
                                                                            ...
                                                                            <Input disabled type="textarea" id="Subject" name="Subject" maxLength="100" rows="13" placeholder="Quote Subject" onChange={handleInputChange} className={errorClass.Subject} value={sqbasicinfo.Subject} />
                                                                        </FormGroup>
                                                                    </Col>
                                                                </div>
                                                                <div className="col-xl-4">
                                                                    <Col md="12">
                                                                        <FormGroup>
                                                                            ...
                                                                            <AutoComplete disabled field="Customer" value={selectedCustomer}
                                                                    ...
                                                                    <Col md="12">
                                                                        <FormGroup>
                                                                            ...
                                                                            <Input disabled type="select" name="DeliveryAddressId" id="DeliveryAddressId" onChange={handleInputChange} className={errorClass.DeliveryAddressId} value={sqbasicinfo.DeliveryAddressId}>
                                                                                <option key="0" value="">Select</option>
                                                                    ...
                                                                    <Col md="12">
                                                                        <FormGroup>
                                                                            ...
                                                                            <InputGroup>
                                                                                <Input type="text" name="EffectiveFromDate" id="EffectiveFromDate" disabled
                                                                                    value={new Date(defaultEffectiveDate).toLocaleDateString('en-GB', {
                                                                                        day: '2-digit',
                                                                                        month: 'short',
                                                                                        year: 'numeric'
                                                                                    }).replace(/ /g, '-')} />
                                                                ...
                                                                <div className="col-xl-4">
                                                                    ...
                                                                    <Col md="12">
                                                                        <FormGroup>
                                                                            ...
                                                                            <InputGroup className="gap-1 flex-wrap">
                                                                                <Input type="text" style={{ width: "70px" }} disabled={true} value={sqbasicinfo.Qtn_Month}></Input>

                                                                                <Input type="text" style={{ width: "40px" }} disabled={true} value={sqbasicinfo.Qtn_Day}></Input>
                                                                    ...
                                                                    <Col md="12">
                                                                        <FormGroup>
                                                                            ...
                                                                            <Input disabled type="text" name="DeliveryTerms" id="DeliveryTerms" onChange={handleInputChange} className={errorClass.DeliveryTerms} value={sqbasicinfo.DeliveryTerms} maxLength={50} />
                                                                        </FormGroup>
                                                                    </Col>
                                                                    <Col md="12">
                                                                        <FormGroup>
                                                                            <Label for="PaymentTermsId" className="required-label">Payment Terms</Label>
                                                                            <Input disabled type="select" name="PaymentTermsId" id="PaymentTermsId" onChange={handleInputChange} className={errorClass.PaymentTerms} value={sqbasicinfo.PaymentTermsId}>
                                                                    ...
                                                                    <Col md="12">
                                                                        <FormGroup>
                                                                            ...
                                                                            <Input disabled type="select" name="PaymentMethodId" id="PaymentMethodId" onChange={handleInputChange} className={errorClass.PaymentMethodId} value={sqbasicinfo.PaymentMethodId} >
                                                                                <option key="0" value="">Select</option>
                                                                        ...
                                                                        {quotationDetails.map((item, index) => {
                                                                            ...
                                                                            return (
                                                                                <tr key={item.GasCodeId || index}>
                                                                                    ...
                                                                                    <td>
                                                                                        <Input type="text" className="text-end" onChange={(e) => handleQtyChange(index, e.target.value)} disabled value={quotationDetails[index]?.Qty || 1} id={`Qty-${index}`} />
                                                                                    </td>
                                                                                    <td>
                                                                                        <Input disabled type="select" onChange={(e) => handleUOMChange(index, e.target.value)} id={`Uom-${index}`} value={quotationDetails[index].Uom}>
                                                                                            <option key="0" value="">Select</option>
                                                                                            {UOMList.map((uom) => (
                                                                                    ...
                                                                                    <td>
                                                                                        <Input type="select" disabled onChange={(e) => handleCurrencyChange(index, e.target.value)} id={`Currency-${index}`} value={quotationDetails[index].ConvertedCurrencyId}>
                                                                                            <option key="0" value="">Select</option>
